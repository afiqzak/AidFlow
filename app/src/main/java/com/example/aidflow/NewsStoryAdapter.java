...
public class NewsStoryAdapter extends RecyclerView.Adapter<NewsStoryAdapter.StoryViewHolder> {

    private Context context;
    private List<Integer> storyImage;

    public NewsStoryAdapter(Context context, List<Integer> storyImage) {
