...
public class WaterNotificationsAdapter extends RecyclerView.Adapter<WaterNotificationsAdapter.NotificationsViewHolder> {

    private final Context context;
    private final List<String> notificationTitles; // list noti text semua silap letak title tapi malas nak tukar

    public WaterNotificationsAdapter(Context context, List<String> notificationTitles) {
