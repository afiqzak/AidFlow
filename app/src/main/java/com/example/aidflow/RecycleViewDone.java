 ...
 * Use the {@link RecycleViewDone#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RecycleViewDone extends Fragment {
    ...
    public static RecycleViewDone newInstance(String param1, String param2) {
        RecycleViewDone fragment = new RecycleViewDone();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recycle_view_done, container, false);
        ...
        adapter = new DoneAdapter(getContext(), pendingTitles);
