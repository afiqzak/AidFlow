...
public class NewsWebFragment extends Fragment {
    ...
    // Declaring the WebView and Button for navigation
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Assigning the views to their respective IDs
        myWebView = view.findViewById(R.id.webview);
        btnBackNews = view.findViewById(R.id.btnBackNews);

        // Setting up the back button to navigate to the home destination
