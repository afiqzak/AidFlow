...
public final class RatingCardviewBinding implements ViewBinding {
  @NonNull
  ...
  private RatingCardviewBinding(@NonNull CardView rootView, @NonNull LinearLayout ratingLabels,
      @NonNull SeekBar ratingSeekbar, @NonNull TextView ratingTitle) {
  ...
  @NonNull
  public static RatingCardviewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RatingCardviewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.rating_cardview, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RatingCardviewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RatingCardviewBinding((CardView) rootView, ratingLabels, ratingSeekbar,
          ratingTitle);
    }
