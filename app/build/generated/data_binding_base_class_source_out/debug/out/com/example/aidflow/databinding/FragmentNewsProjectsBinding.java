...
public final class FragmentNewsProjectsBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentNewsProjectsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentNewsProjectsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_news_projects, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentNewsProjectsBinding bind(@NonNull View rootView) {
