...
public final class SingleNewsCardBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static SingleNewsCardBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SingleNewsCardBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.single_news_card, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SingleNewsCardBinding bind(@NonNull View rootView) {
