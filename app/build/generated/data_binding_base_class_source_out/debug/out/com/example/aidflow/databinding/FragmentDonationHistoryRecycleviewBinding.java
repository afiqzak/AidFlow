...
public final class FragmentDonationHistoryRecycleviewBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView organizerNameHistory;
  ...
  private FragmentDonationHistoryRecycleviewBinding(@NonNull CardView rootView,
      @NonNull TextView amountHistory, @NonNull TextView donationDateHistory,
      @NonNull TextView donationNameHistory, @NonNull TextView organizerNameHistory,
      @NonNull TextView paymentMethodHistory, @NonNull TextView projectNameHistory,
    ...
    this.organizerNameHistory = organizerNameHistory;
  ...
  @NonNull
  public static FragmentDonationHistoryRecycleviewBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static FragmentDonationHistoryRecycleviewBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.fragment_donation_history_recycleview, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentDonationHistoryRecycleviewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.organizerName_history;
      TextView organizerNameHistory = ViewBindings.findChildViewById(rootView, id);
      if (organizerNameHistory == null) {
        break missingId;
      }
      ...
      return new FragmentDonationHistoryRecycleviewBinding((CardView) rootView, amountHistory,
          donationDateHistory, donationNameHistory, organizerNameHistory, paymentMethodHistory,
          projectNameHistory, urgencyIndicator);
    }
