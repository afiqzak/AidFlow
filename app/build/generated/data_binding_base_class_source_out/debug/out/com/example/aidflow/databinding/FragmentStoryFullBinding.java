...
public final class FragmentStoryFullBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentStoryFullBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentStoryFullBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentStoryFullBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_story_full, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentStoryFullBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentStoryFullBinding((ConstraintLayout) rootView, btnBack, frameLayout,
